...
class CompraController extends Controller
{
    ...
    public function update_aprobar_status(Request $request)
    {
        ...
        return redirect()->action('CompraController@index_pendientes')->with('status', 'Factura aprobada!');
    }
    ...
    {   
        ...
        return redirect()->action('CompraController@index_pendientes')->with('status', 'Factura rechazada!');
    }
    ...
    {   
        ...
        $datos['clientes']    = Cliente::where('status','=',1)->where('tipo_cliente','=','PROVEEDOR')->get();
        $sistema              = Configuracion::where('id', '=', 1)->firstOrFail();
        return view('Back.compra.pos.index_pos', compact('sistema','datos'));
    }
    ...
    public function pos_insertar_producto_temporal(Request $request)
    {
        ...
        //cantidad condicionada a que esté vacia o sea cero en el formulario
    ...
    {        
        ...
        return $pdf->download(__('idioma.compra_pendi_titu').'.pdf');
    }
    ...
    {        
        ...
        return $pdf->download(__('idioma.compra_rech_titu').'.pdf');
    }
    ...
    {        
        ...
        return $pdf->download(__('idioma.compra_apro_titu').'.pdf');
    }
    ...
    {        
        ...
        $pdf = PDF::loadView('Back.pdf.compras.factura', compact('datos', 'sistema', 'fecha', 'detalles', 'ahorro'));
