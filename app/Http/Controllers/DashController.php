...
class DashController extends Controller {
    ...
    public function dash() {
        ...
        //Ventas
        // $ventas_existencia        = Posproceso::where('tipo_proceso', '=', 'Sales')->where('status', '=', 2)->count();
        $ultimas_ventas  		  = Posproceso::where('tipo_proceso', '=', 'Sales')->orderBy('created_at', 'desc')->limit(3)->get();

        //Calcular total de ventas
        // $consulta_ventas  		  = Posproceso::where('tipo_proceso', '=', 'Sales')->where('status', '=', 2)->get();
        // $total_ventas             = 0;
        ...
        return view('Back.index', compact('sistema', 'usuarios_existencia', 'ultimas_ventas', 'clientes_existencia',));
