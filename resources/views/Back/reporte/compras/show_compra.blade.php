@extends('Back.master')
@section('title', __('idioma.rep_com_tit'))
@section('active-reportes', 'active')
@section('active-reportes-compras', 'active')
@section('content')
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">@lang('idioma.rep_com_tit') </h4>
                        <ol class="breadcrumb p-0 m-0">
                            <li>
                                <a href="{{ route('dash') }}">{{$sistema->nombre_empresa}}</a>
                            </li>
                            <li>
                                <a href="{{ url('/clientes') }}">@lang('idioma.rep_com_tit')</a>
                            </li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        @if(count($datos) != 0)
                            <a href="{{url('/pdf_reporte_compras',array('desde'=>$desde,'hasta'=>$hasta, 'status'=>$status))}}" class="btn btn-danger"><i class="fa fa-print"></i>{{" PDF "}}</a>
                            <a href="{{url('/csv_reporte_compras',array('desde'=>$desde,'hasta'=>$hasta, 'status' => $status))}}" class="btn btn-success pull-left"><i class="fa fa-file-excel-o"></i> {{"CSV"}} </a>
                        @else
