            ...
            @if(Session::get("rol_id") == 1 or Session::get("rol_id") == 2 or $permisos->compra_r == 1 or $permisos->venta_r == 1)
                <ul class="nav navbar-nav navbar-left">
                    ...
                    @if(Session::get("rol_id") == 1 or Session::get("rol_id") == 2 or $permisos->compra_r == 1)
                        <li>
                            <a href="{{ route('purchase') }}" class="right-bar-toggle right-menu-item btn btn-success" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="@lang('idioma.comprar_ahora')">
            ...
            <ul>
                ...
                @if(Session::get("rol_id"))
                    ...
                    <li class="@yield('active-producto')">
                        <a href="{{ route('products') }}" class="waves-effect @yield('active-producto')"><i class="mdi mdi-package-variant"></i><span>@lang('idioma.nav_produc')<span></a>
                    </li>
                    @endif
                @endif
