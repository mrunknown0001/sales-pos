...
<html lang="en">
    <head>
        ...
        @if($configuracion->logo)
            <link rel="shortcut icon" href="{{ asset('/storage/img_sistema/'.$configuracion->logo) }}">
        @else
            <link rel="shortcut icon" href="{{ asset('/storage/img_sistema/default_logo.jpg') }}">
        @endif
        <!-- App title -->
        <title>{{'Login'}}</title>
        <!-- App css -->
        ...
        <link href="{{ asset('/Back/assets/css/pages.css') }}" rel="stylesheet" type="text/css" />
        ...
        <!--PRELOADER-->
        <link rel="stylesheet" href="{{asset('/Back/preloader/css_loader.css')}}"></link>
    </head>
    <body class="bg-transparent">
                        ...
                        <div class="wrapper-page">
                                ...
                                <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="{{ route('login') }}" class="text-success">
                                            <span>
                                                @if($configuracion->logo)
                                                    <img style="width:100px; height:100px" src="{{ asset('/storage/img_sistema/'.$configuracion->logo) }}">
                                                @else
                            ...
                            <div class="row m-t-50">
                                ...
                                <div class="col-sm-12 text-center">
                                    <p class="text-muted">@lang('idioma.auth_sin_cuenta')<a href="{{route('register')}}" class="text-primary m-l-5"><b>@lang('idioma.auth_lin_regis')</b></a></p>
                                </div>
                                @endif
                                <!--LOADER-->
                                 <div class="col-xs-12">
        ...
        <!--ALERTAS-->
        <script src="{{asset('/Back/alertifyjs/alertify.min.js')}}"></script>
