                            ...
                            <div class="col-md-12">
                                ...
                                <form action="{{ route('location.update', $location->id) }}" method="POST" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{ ($errors->first('location_name')) ? 'error' : '' }}" id="location_name" maxlength="100" value="{{ $location->location_name }}"  name="location_name" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{ ($errors->first('location_code')) ? 'error' : '' }}" id="location_code" maxlength="100" value="{{ $location->location_code }}" name="location_code" />
