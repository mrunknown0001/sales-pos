@extends('Back.compra.pos.master_pos')
@section('title',  __('idioma.pos_c_titulo'))
                    ...
                    <div class="panel-body">
                        <div class="clearfix">
                            ...
                            <div class="pull-right"> 
                                <h1>@lang('idioma.pos_c_titulo') #<span id="codigo">{{$datos['n_factura']}}</span></h1>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                                ...
                                <div class="m-t-20 col-md-12 col-xs-12">
                                    <label for="cliente">@lang('idioma.pos_c_escoja_pro')</label>
            ...
            <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h4 class="modal-title">@lang('idioma.pos_c_ti_md_pro')</h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="numeroProceso" class="control-label">@lang('idioma.pos_cod_compra')</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group no-margin">
                                        ...
                                        <textarea class="form-control autogrow" id="modal_comentario" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 104px;"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="account-content">
                                    <div class="text-center m-b-20">
                                        ...
                                        <h3>@lang('idioma.pos_c_msg_succes')</h3>
