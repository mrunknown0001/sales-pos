@extends('Back.master')
@section('title',  __('idioma.vent_pendi_titu'))
@section('active-ventas', 'active subdrop')
@section('active-ventas-pendientes', 'active')
@section('content')
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">@lang('idioma.vent_pendi_titu')</h4>
                        <ol class="breadcrumb p-0 m-0">
                            <li>
                                <a href="{{ url('/dash') }}">{{$sistema->nombre_empresa}}</a>
                            </li>
                            <li class="active">
                                @lang('idioma.vent_pendi_titu')
                            </li>
                        </ol>
                            ...
                            @foreach($datos as $key => $d)
                                <tr>
                                   ...
                                   <td>
                                       ...
                                       <a title="@lang('idioma.gral_aprobar')" data-toggle="modal" data-target="#modal_aprobar_venta{{$d->id}}" href="#" class="btn btn-success waves-effect waves-light"><i class="fa fa-check"></i></a>
                                       <a title="@lang('idioma.ven_btn_rechazar')" data-toggle="modal" data-target="#modal_rechazar_venta{{$d->id}}" href="#" class="btn btn-danger waves-effect waves-light"><i class="fa fa-times"></i></a>
                                        ...
                                        *******************************************************************
                                        ...
                                        <div id="modal_aprobar_venta{{$d->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog">
                                                <div class="modal-content p-0 b-0">
                                                    <div class="panel panel-color panel-success">
                                                        <div class="panel-heading">
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                            <h3 class="panel-title">@lang('idioma.ven_modal_apro')</h3>
                                                        </div>
                                                        <form role="form" method="post" action="{{action('VentaController@update_aprobar_status')}}">
                                        ...
                                        <div id="modal_rechazar_venta{{$d->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog">
                                                <div class="modal-content p-0 b-0">
                                                    <div class="panel panel-color panel-danger">
                                                        <div class="panel-heading">
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                            <h3 class="panel-title">@lang('idioma.ven_modal_recha')</h3>
                                                        </div>
                                                        <form role="form" method="post" action="{{action('VentaController@update_rechazar_status')}}">
                                                            <input type="hidden" name="_token" value="{!! csrf_token() !!}">
                                                            <div class="panel-body text-center">
                                                                <div class="row">
                                                                    <input name="id" type="hidden" value="{{$d->id}}">
