                    ...
                    <table>
                        <tr>
                            ...
                            @if($sistema->logo != "")
                                  ...
                                  @else
                                      <a href="" class="dropdown-toggle waves-effect user-link" data-toggle="dropdown" aria-expanded="true">
                                          {{-- <img src="{{ url('/storage/img_sistema/default_logo.jpg') }}" alt="{{$datos->nombre_empresa}}" class="img-circle user-img"> --}}
                                      </a>
                                  @endif
                            </td>
                            
                            <td>
                                <strong>@lang('idioma.dash_venta') #: {{ $datos->codigo_proceso }}<br></strong>
        ...
        @if($datos->status==0)
            <table>
                @if($datos->motivo_rechazo)
                    ...
                    <tr colspan="7" style="background-color:#eae3e3">
                        <td style="width:260px;font-size: 9pt;"><br><strong>@lang('idioma.ven_motivo'):</strong> {{$datos->motivo_rechazo}}</td>
                    </tr>

                @else
                    <tr colspan="7" style="background-color:#eae3e3">
                        <td style="width:260px;font-size: 9pt;"><br><strong>@lang('idioma.ven_motivo'):</strong>@lang('idioma.ven_sin_motivo')</td>
                    </tr>
